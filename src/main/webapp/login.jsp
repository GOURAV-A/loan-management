...
function valiDateEmail(){
	window.location.href='EmailValidationResetPass.jsp';
	return false;
}
        ...
        function loginFormValidation(){
        	...
        	var captcha=document.getElementById("txtCompare").value;
...
<body onload="GenerateCaptcha();">
	...
	<header class="header-section">
		...
		<nav class="header-nav">
			<div class="header-right">
				...
				<div class="hr-btn hr-btn-2">+91 9620827004</div>
			</div>
		</nav>
	</header>
	<!-- Header Section end -->
	...
	<section class="hero-section">
		<div class="container">
			<div class="row">
               ...
               <% } %>
					<form class="hero-form" action="loginServlet" method="post">
					<h3 style="color: red">Login Module </h3>
						<input type="text" placeholder="Your User Id" name="userid" id="userId">
						<input type="password" placeholder="Your password" name="password" id="password">
                       <input type="text" id="txtCompare" placeholder="Please enter captcha "/>  
                       ...
                       <input type="text" id="txtCaptcha" style="text-align: center; border: none; font-weight: bold; font-size: 20px; font-family: Modern" />  
						<button class="site-btn" onclick="return loginFormValidation();">Login</button>
						<button class="site-btn" onclick="return valiDateEmail();">Forgot Password </button>
					</form>
	...
	<footer class="footer-section">
		<div class="container">
			...
			<p>Education loans can be a viable option in a variety of circumstances. First, let’s define a Education loan. Some loans are earmarked for a specific purchase. You buy a home with a mortgage loan, you purchase a car with an auto loan and you pay for college with a student loan.</p>
		<div class="copyright">
