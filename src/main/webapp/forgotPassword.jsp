	...
	<section class="hero-section">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6">
					<form class="hero-form" action="forgotPasswordservlet" method="post">
						<a href="login.jsp"><b style="font-size: 24px">Click me to Login</b></a>
						<h3 style="color: red">Change Password screen</h3>
						<input type="text" placeholder="Your email" name="email">
						<input type="password" placeholder="Your New password" name="passwordNew">
